## Full Stack Trading-Platform Using Spring Boot and React
...
# AI Chat Bot  
Leverage our AI Chat Bot, designed to handle crypto-related queries like value of crypto and market data using Gemini API and CoinGecko API for real-time data.
